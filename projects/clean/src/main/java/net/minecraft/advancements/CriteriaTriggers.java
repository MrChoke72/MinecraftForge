...
public class CriteriaTriggers {
   ...
   public static final RightClickBlockWithItemTrigger field_229863_J_ = register(new RightClickBlockWithItemTrigger(new ResourceLocation("safely_harvest_honey")));
