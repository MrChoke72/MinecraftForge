...
public class PlayerPredicate {
   ...
   public boolean func_226998_a_(Entity p_226998_1_) {
      if (this == field_226989_a_) {
         ...
         if (!this.field_226990_b_.test(serverplayerentity.experienceLevel)) {
            return false;
         } else if (this.field_226991_c_ != GameType.NOT_SET && this.field_226991_c_ != serverplayerentity.interactionManager.getGameType()) {
            return false;
         } else {
   ...
   public JsonElement func_226995_a_() {
      if (this == field_226989_a_) {
         ...
         jsonobject.add("level", this.field_226990_b_.serialize());
         if (this.field_226991_c_ != GameType.NOT_SET) {
            jsonobject.addProperty("gamemode", this.field_226991_c_.getName());
         }
