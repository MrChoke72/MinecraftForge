   ...
   public double func_215462_a(double p_215462_1_, double p_215462_3_, double p_215462_5_, double p_215462_7_, double p_215462_9_, boolean p_215462_11_) {
      ...
      for(ImprovedNoiseGenerator improvednoisegenerator : this.octaves) {
         if (improvednoisegenerator != null) {
            d0 += improvednoisegenerator.func_215456_a(maintainPrecision(p_215462_1_ * d1), p_215462_11_ ? -improvednoisegenerator.yCoord : maintainPrecision(p_215462_3_ * d1), maintainPrecision(p_215462_5_ * d1), p_215462_7_ * d1, p_215462_9_ * d1) * d2;
         }
