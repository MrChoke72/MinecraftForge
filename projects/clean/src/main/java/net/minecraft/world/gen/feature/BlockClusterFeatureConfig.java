...
public class BlockClusterFeatureConfig implements IFeatureConfig {
   ...
   public <T> Dynamic<T> serialize(DynamicOps<T> ops) {
      ...
      builder.put(ops.createString("state_provider"), this.field_227289_a_.serialize(ops)).put(ops.createString("block_placer"), this.field_227290_b_.serialize(ops)).put(ops.createString("whitelist"), ops.createList(this.field_227291_c_.stream().map((p_227301_1_) -> {
