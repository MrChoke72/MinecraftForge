...
public class IglooPieces {
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         int i = p_225577_1_.getHeight(Heightmap.Type.WORLD_SURFACE_WG, blockpos1.getX(), blockpos1.getZ());
         BlockPos blockpos2 = this.templatePosition;
         this.templatePosition = this.templatePosition.add(0, i - 90 - 1, 0);
         boolean flag = super.func_225577_a_(p_225577_1_, p_225577_2_, p_225577_3_, p_225577_4_, p_225577_5_);
         if (this.field_207615_d.equals(IglooPieces.field_202592_e)) {
            ...
            BlockState blockstate = p_225577_1_.getBlockState(blockpos3.down());
            if (!blockstate.isAir() && blockstate.getBlock() != Blocks.LADDER) {
               p_225577_1_.setBlockState(blockpos3, Blocks.SNOW_BLOCK.getDefaultState(), 3);
            }
         }
