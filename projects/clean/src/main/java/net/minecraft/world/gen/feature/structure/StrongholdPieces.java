...
public class StrongholdPieces {
   ...
   public static class ChestCorridor extends StrongholdPieces.Stronghold {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         for(int i = 2; i <= 4; ++i) {
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICK_SLAB.getDefaultState(), 2, 1, i, p_225577_4_);
         }
   ...
   public static class Corridor extends StrongholdPieces.Stronghold {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         for(int i = 0; i < this.steps; ++i) {
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 0, 0, i, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 1, 0, i, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 2, 0, i, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 3, 0, i, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 4, 0, i, p_225577_4_);

            for(int j = 1; j <= 3; ++j) {
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 0, j, i, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.CAVE_AIR.getDefaultState(), 1, j, i, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.CAVE_AIR.getDefaultState(), 2, j, i, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.CAVE_AIR.getDefaultState(), 3, j, i, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 4, j, i, p_225577_4_);
            }

            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 0, 4, i, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 1, 4, i, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 2, 4, i, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 3, 4, i, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 4, 4, i, p_225577_4_);
         }
   ...
   public static class Library extends StrongholdPieces.Stronghold {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 0, 0, 0, 13, i - 1, 14, true, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         for(int l = 1; l <= 13; ++l) {
            if ((l - 1) % 4 == 0) {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, 1, l, 1, 4, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 12, 1, l, 12, 4, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
               this.setBlockState(p_225577_1_, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.EAST), 2, 3, l, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.WALL_TORCH.getDefaultState().with(WallTorchBlock.HORIZONTAL_FACING, Direction.WEST), 11, 3, l, p_225577_4_);
               if (this.isLargeRoom) {
                  this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, 6, l, 1, 9, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
                  this.fillWithBlocks(p_225577_1_, p_225577_4_, 12, 6, l, 12, 9, l, Blocks.OAK_PLANKS.getDefaultState(), Blocks.OAK_PLANKS.getDefaultState(), false);
               }
            } else {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, 1, l, 1, 4, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 12, 1, l, 12, 4, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
               if (this.isLargeRoom) {
                  this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, 6, l, 1, 9, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
                  this.fillWithBlocks(p_225577_1_, p_225577_4_, 12, 6, l, 12, 9, l, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
               }
            }
         }

         for(int l1 = 3; l1 < 12; l1 += 2) {
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 3, 1, l1, 4, 3, l1, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 6, 1, l1, 7, 3, l1, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 9, 1, l1, 10, 3, l1, Blocks.BOOKSHELF.getDefaultState(), Blocks.BOOKSHELF.getDefaultState(), false);
         }
         ...
         if (this.isLargeRoom) {
            ...
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 3, 6, 3, 3, 6, 11, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 10, 6, 3, 10, 6, 9, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 4, 6, 2, 9, 6, 2, blockstate5, blockstate5, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 4, 6, 12, 7, 6, 12, blockstate5, blockstate5, false);
            this.setBlockState(p_225577_1_, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, Boolean.valueOf(true)).with(FenceBlock.EAST, Boolean.valueOf(true)), 3, 6, 2, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, Boolean.valueOf(true)).with(FenceBlock.EAST, Boolean.valueOf(true)), 3, 6, 12, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, Boolean.valueOf(true)).with(FenceBlock.WEST, Boolean.valueOf(true)), 10, 6, 2, p_225577_4_);

            for(int i1 = 0; i1 <= 2; ++i1) {
               this.setBlockState(p_225577_1_, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.SOUTH, Boolean.valueOf(true)).with(FenceBlock.WEST, Boolean.valueOf(true)), 8 + i1, 6, 12 - i1, p_225577_4_);
               if (i1 != 2) {
                  this.setBlockState(p_225577_1_, Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.NORTH, Boolean.valueOf(true)).with(FenceBlock.EAST, Boolean.valueOf(true)), 8 + i1, 6, 11 - i1, p_225577_4_);
               }
            }

            BlockState blockstate6 = Blocks.LADDER.getDefaultState().with(LadderBlock.FACING, Direction.SOUTH);
            this.setBlockState(p_225577_1_, blockstate6, 10, 1, 13, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate6, 10, 2, 13, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate6, 10, 3, 13, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate6, 10, 4, 13, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate6, 10, 5, 13, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate6, 10, 6, 13, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate6, 10, 7, 13, p_225577_4_);
            int j1 = 7;
            int k1 = 7;
            BlockState blockstate1 = Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.EAST, Boolean.valueOf(true));
            this.setBlockState(p_225577_1_, blockstate1, 6, 9, 7, p_225577_4_);
            BlockState blockstate2 = Blocks.OAK_FENCE.getDefaultState().with(FenceBlock.WEST, Boolean.valueOf(true));
            this.setBlockState(p_225577_1_, blockstate2, 7, 9, 7, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate1, 6, 8, 7, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate2, 7, 8, 7, p_225577_4_);
            BlockState blockstate3 = blockstate.with(FenceBlock.WEST, Boolean.valueOf(true)).with(FenceBlock.EAST, Boolean.valueOf(true));
            this.setBlockState(p_225577_1_, blockstate3, 6, 7, 7, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate3, 7, 7, 7, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate1, 5, 7, 7, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate2, 8, 7, 7, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate1.with(FenceBlock.NORTH, Boolean.valueOf(true)), 6, 7, 6, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate1.with(FenceBlock.SOUTH, Boolean.valueOf(true)), 6, 7, 8, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate2.with(FenceBlock.NORTH, Boolean.valueOf(true)), 7, 7, 6, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate2.with(FenceBlock.SOUTH, Boolean.valueOf(true)), 7, 7, 8, p_225577_4_);
            BlockState blockstate4 = Blocks.TORCH.getDefaultState();
            this.setBlockState(p_225577_1_, blockstate4, 5, 8, 7, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate4, 8, 8, 7, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate4, 6, 8, 6, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate4, 6, 8, 8, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate4, 7, 8, 6, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate4, 7, 8, 8, p_225577_4_);
         }
   ...
   public static class PortalRoom extends StrongholdPieces.Stronghold {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         int i = 6;
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 1, i, 1, 1, i, 14, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 9, i, 1, 9, i, 14, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 2, i, 1, 8, i, 2, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         this.fillWithRandomizedBlocks(p_225577_1_, p_225577_4_, 2, i, 14, 8, i, 14, false, p_225577_3_, StrongholdPieces.STRONGHOLD_STONES);
         ...
         for(int j = 3; j < 14; j += 2) {
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, 3, j, 0, 4, j, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 10, 3, j, 10, 4, j, blockstate, blockstate, false);
         }

         for(int i1 = 2; i1 < 9; i1 += 2) {
            this.fillWithBlocks(p_225577_1_, p_225577_4_, i1, 3, 15, i1, 4, 15, blockstate1, blockstate1, false);
         }
         ...
         for(int k = 4; k <= 6; ++k) {
            this.setBlockState(p_225577_1_, blockstate5, k, 1, 4, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate5, k, 2, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate5, k, 3, 6, p_225577_4_);
         }
         ...
         for(int l = 0; l < aboolean.length; ++l) {
            aboolean[l] = p_225577_3_.nextFloat() > 0.9F;
            flag &= aboolean[l];
         }

         this.setBlockState(p_225577_1_, blockstate6.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[0])), 4, 3, 8, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate6.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[1])), 5, 3, 8, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate6.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[2])), 6, 3, 8, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate2.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[3])), 4, 3, 12, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate2.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[4])), 5, 3, 12, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate2.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[5])), 6, 3, 12, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate3.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[6])), 3, 3, 9, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate3.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[7])), 3, 3, 10, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate3.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[8])), 3, 3, 11, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate4.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[9])), 7, 3, 9, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate4.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[10])), 7, 3, 10, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate4.with(EndPortalFrameBlock.EYE, Boolean.valueOf(aboolean[11])), 7, 3, 11, p_225577_4_);
         if (flag) {
            BlockState blockstate7 = Blocks.END_PORTAL.getDefaultState();
            this.setBlockState(p_225577_1_, blockstate7, 4, 3, 9, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate7, 5, 3, 9, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate7, 6, 3, 9, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate7, 4, 3, 10, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate7, 5, 3, 10, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate7, 6, 3, 10, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate7, 4, 3, 11, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate7, 5, 3, 11, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate7, 6, 3, 11, p_225577_4_);
         }
   ...
   public static class Prison extends StrongholdPieces.Stronghold {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         for(int i = 1; i <= 3; ++i) {
            this.setBlockState(p_225577_1_, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)), 4, i, 4, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)).with(PaneBlock.EAST, Boolean.valueOf(true)), 4, i, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)), 4, i, 6, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, Boolean.valueOf(true)).with(PaneBlock.EAST, Boolean.valueOf(true)), 5, i, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, Boolean.valueOf(true)).with(PaneBlock.EAST, Boolean.valueOf(true)), 6, i, 5, p_225577_4_);
            this.setBlockState(p_225577_1_, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.WEST, Boolean.valueOf(true)).with(PaneBlock.EAST, Boolean.valueOf(true)), 7, i, 5, p_225577_4_);
         }

         this.setBlockState(p_225577_1_, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)), 4, 3, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.IRON_BARS.getDefaultState().with(PaneBlock.NORTH, Boolean.valueOf(true)).with(PaneBlock.SOUTH, Boolean.valueOf(true)), 4, 3, 8, p_225577_4_);
         ...
         this.setBlockState(p_225577_1_, blockstate1, 4, 1, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate, 4, 2, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate1, 4, 1, 8, p_225577_4_);
         this.setBlockState(p_225577_1_, blockstate, 4, 2, 8, p_225577_4_);
         return true;
      }
   }
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         case 1:
            for(int i1 = 0; i1 < 5; ++i1) {
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 3, 1, 3 + i1, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 7, 1, 3 + i1, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 3 + i1, 1, 3, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 3 + i1, 1, 7, p_225577_4_);
            }
         ...
         case 2:
            for(int i = 1; i <= 9; ++i) {
               this.setBlockState(p_225577_1_, Blocks.COBBLESTONE.getDefaultState(), 1, 3, i, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.COBBLESTONE.getDefaultState(), 9, 3, i, p_225577_4_);
            }

            for(int j = 1; j <= 9; ++j) {
               this.setBlockState(p_225577_1_, Blocks.COBBLESTONE.getDefaultState(), j, 3, 1, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.COBBLESTONE.getDefaultState(), j, 3, 9, p_225577_4_);
            }
            ...
            for(int k = 1; k <= 3; ++k) {
               this.setBlockState(p_225577_1_, Blocks.COBBLESTONE.getDefaultState(), 4, k, 4, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.COBBLESTONE.getDefaultState(), 6, k, 4, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.COBBLESTONE.getDefaultState(), 4, k, 6, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.COBBLESTONE.getDefaultState(), 6, k, 6, p_225577_4_);
            }

            this.setBlockState(p_225577_1_, Blocks.TORCH.getDefaultState(), 5, 3, 5, p_225577_4_);

            for(int l = 2; l <= 8; ++l) {
               this.setBlockState(p_225577_1_, Blocks.OAK_PLANKS.getDefaultState(), 2, 3, l, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.OAK_PLANKS.getDefaultState(), 3, 3, l, p_225577_4_);
               if (l <= 3 || l >= 7) {
                  this.setBlockState(p_225577_1_, Blocks.OAK_PLANKS.getDefaultState(), 4, 3, l, p_225577_4_);
                  this.setBlockState(p_225577_1_, Blocks.OAK_PLANKS.getDefaultState(), 5, 3, l, p_225577_4_);
                  this.setBlockState(p_225577_1_, Blocks.OAK_PLANKS.getDefaultState(), 6, 3, l, p_225577_4_);
               }

               this.setBlockState(p_225577_1_, Blocks.OAK_PLANKS.getDefaultState(), 7, 3, l, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.OAK_PLANKS.getDefaultState(), 8, 3, l, p_225577_4_);
            }

            BlockState blockstate = Blocks.LADDER.getDefaultState().with(LadderBlock.FACING, Direction.WEST);
            this.setBlockState(p_225577_1_, blockstate, 9, 1, 3, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate, 9, 2, 3, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate, 9, 3, 3, p_225577_4_);
   ...
   public static class StairsStraight extends StrongholdPieces.Stronghold {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         for(int i = 0; i < 6; ++i) {
            this.setBlockState(p_225577_1_, blockstate, 1, 6 - i, 1 + i, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate, 2, 6 - i, 1 + i, p_225577_4_);
            this.setBlockState(p_225577_1_, blockstate, 3, 6 - i, 1 + i, p_225577_4_);
            if (i < 5) {
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 1, 5 - i, 1 + i, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 2, 5 - i, 1 + i, p_225577_4_);
               this.setBlockState(p_225577_1_, Blocks.STONE_BRICKS.getDefaultState(), 3, 5 - i, 1 + i, p_225577_4_);
            }
         }
   ...
   public static class Straight extends StrongholdPieces.Stronghold {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         this.randomlyPlaceBlock(p_225577_1_, p_225577_4_, p_225577_3_, 0.1F, 1, 2, 1, blockstate);
         this.randomlyPlaceBlock(p_225577_1_, p_225577_4_, p_225577_3_, 0.1F, 3, 2, 1, blockstate1);
         this.randomlyPlaceBlock(p_225577_1_, p_225577_4_, p_225577_3_, 0.1F, 1, 2, 5, blockstate);
         this.randomlyPlaceBlock(p_225577_1_, p_225577_4_, p_225577_3_, 0.1F, 3, 2, 5, blockstate1);
         if (this.expandsX) {
