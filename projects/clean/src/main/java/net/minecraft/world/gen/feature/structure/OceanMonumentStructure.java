...
public class OceanMonumentStructure extends Structure<NoFeatureConfig> {
   ...
   public boolean func_225558_a_(BiomeManager p_225558_1_, ChunkGenerator<?> p_225558_2_, Random p_225558_3_, int p_225558_4_, int p_225558_5_, Biome p_225558_6_) {
      ...
      if (p_225558_4_ == chunkpos.x && p_225558_5_ == chunkpos.z) {
         for(Biome biome : p_225558_2_.getBiomeProvider().func_225530_a_(p_225558_4_ * 16 + 9, p_225558_2_.getSeaLevel(), p_225558_5_ * 16 + 9, 16)) {
            if (!p_225558_2_.hasStructure(biome, this)) {
               return false;
            }
         }

         for(Biome biome1 : p_225558_2_.getBiomeProvider().func_225530_a_(p_225558_4_ * 16 + 9, p_225558_2_.getSeaLevel(), p_225558_5_ * 16 + 9, 29)) {
