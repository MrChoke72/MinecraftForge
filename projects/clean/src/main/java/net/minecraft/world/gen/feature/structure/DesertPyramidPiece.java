...
public class DesertPyramidPiece extends ScatteredStructurePiece {
   ...
   public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
      ...
      for(int i = 1; i <= 9; ++i) {
         this.fillWithBlocks(p_225577_1_, p_225577_4_, i, i, i, this.width - 1 - i, i, this.depth - 1 - i, Blocks.SANDSTONE.getDefaultState(), Blocks.SANDSTONE.getDefaultState(), false);
         this.fillWithBlocks(p_225577_1_, p_225577_4_, i + 1, i, i + 1, this.width - 2 - i, i, this.depth - 2 - i, Blocks.AIR.getDefaultState(), Blocks.AIR.getDefaultState(), false);
      }

      for(int k1 = 0; k1 < this.width; ++k1) {
         for(int j = 0; j < this.depth; ++j) {
            int k = -5;
            this.replaceAirAndLiquidDownwards(p_225577_1_, Blocks.SANDSTONE.getDefaultState(), k1, -5, j, p_225577_4_);
         }
      }
      ...
      this.setBlockState(p_225577_1_, blockstate1, 2, 10, 0, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate2, 2, 10, 4, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate3, 0, 10, 2, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate, 4, 10, 2, p_225577_4_);
      ...
      this.setBlockState(p_225577_1_, blockstate1, this.width - 3, 10, 0, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate2, this.width - 3, 10, 4, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate3, this.width - 5, 10, 2, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate, this.width - 1, 10, 2, p_225577_4_);
      ...
      this.setBlockState(p_225577_1_, blockstate1, 2, 4, 5, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate1, 2, 3, 4, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate1, this.width - 3, 4, 5, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate1, this.width - 3, 3, 4, p_225577_4_);
      ...
      this.setBlockState(p_225577_1_, blockstate, 2, 1, 2, p_225577_4_);
      this.setBlockState(p_225577_1_, blockstate3, this.width - 3, 1, 2, p_225577_4_);
      ...
      for(int l = 5; l <= 17; l += 2) {
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), 4, 1, l, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CHISELED_SANDSTONE.getDefaultState(), 4, 2, l, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), this.width - 5, 1, l, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CHISELED_SANDSTONE.getDefaultState(), this.width - 5, 2, l, p_225577_4_);
      }
      ...
      for(int l1 = 0; l1 <= this.width - 1; l1 += this.width - 1) {
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 2, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 2, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 2, 3, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 3, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 3, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 3, 3, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 4, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CHISELED_SANDSTONE.getDefaultState(), l1, 4, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 4, 3, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 5, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 5, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 5, 3, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 6, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CHISELED_SANDSTONE.getDefaultState(), l1, 6, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 6, 3, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 7, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 7, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), l1, 7, 3, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 8, 1, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 8, 2, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), l1, 8, 3, p_225577_4_);
      }

      for(int i2 = 2; i2 <= this.width - 3; i2 += this.width - 3 - 2) {
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2 - 1, 2, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2, 2, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2 + 1, 2, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2 - 1, 3, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2, 3, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2 + 1, 3, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 - 1, 4, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CHISELED_SANDSTONE.getDefaultState(), i2, 4, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 + 1, 4, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2 - 1, 5, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2, 5, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2 + 1, 5, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 - 1, 6, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CHISELED_SANDSTONE.getDefaultState(), i2, 6, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 + 1, 6, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 - 1, 7, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2, 7, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.ORANGE_TERRACOTTA.getDefaultState(), i2 + 1, 7, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2 - 1, 8, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2, 8, 0, p_225577_4_);
         this.setBlockState(p_225577_1_, Blocks.CUT_SANDSTONE.getDefaultState(), i2 + 1, 8, 0, p_225577_4_);
      }
      ...
      for(Direction direction : Direction.Plane.HORIZONTAL) {
         if (!this.hasPlacedChest[direction.getHorizontalIndex()]) {
            ...
            this.hasPlacedChest[direction.getHorizontalIndex()] = this.generateChest(p_225577_1_, p_225577_4_, p_225577_3_, 10 + i1, -11, 10 + j1, LootTables.CHESTS_DESERT_PYRAMID);
         }
      }
