...
public class OceanMonumentPieces {
   public static class DoubleXRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (this.roomDefinition.index / 25 > 0) {
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 8, 0, oceanmonumentpieces$roomdefinition.hasOpening[Direction.DOWN.getIndex()]);
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 0, 0, oceanmonumentpieces$roomdefinition1.hasOpening[Direction.DOWN.getIndex()]);
         }
   ...
   public static class DoubleXYRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         for(int i = 1; i <= 7; ++i) {
            ...
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, i, 0, 0, i, 7, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 15, i, 0, 15, i, 7, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, i, 0, 15, i, 0, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, i, 7, 14, i, 7, blockstate, blockstate, false);
         }
   ...
   public static class DoubleYRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         for(int i = 1; i <= 5; i += 4) {
            int j = 0;
            if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.SOUTH.getIndex()]) {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 2, i, j, 2, i + 2, j, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 5, i, j, 5, i + 2, j, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 3, i + 2, j, 4, i + 2, j, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
            } else {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, i, j, 7, i + 2, j, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, i + 1, j, 7, i + 1, j, ROUGH_PRISMARINE, ROUGH_PRISMARINE, false);
            }
            ...
            int k = 0;
            if (oceanmonumentpieces$roomdefinition1.hasOpening[Direction.WEST.getIndex()]) {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, k, i, 2, k, i + 2, 2, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, k, i, 5, k, i + 2, 5, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, k, i + 2, 3, k, i + 2, 4, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
            } else {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, k, i, 0, k, i + 2, 7, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, k, i + 1, 0, k, i + 1, 7, ROUGH_PRISMARINE, ROUGH_PRISMARINE, false);
            }
   ...
   public static class DoubleYZRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         if (this.roomDefinition.index / 25 > 0) {
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 0, 8, oceanmonumentpieces$roomdefinition.hasOpening[Direction.DOWN.getIndex()]);
            this.generateDefaultFloor(p_225577_1_, p_225577_4_, 0, 0, oceanmonumentpieces$roomdefinition1.hasOpening[Direction.DOWN.getIndex()]);
         }
         ...
         for(int i = 1; i <= 7; ++i) {
            ...
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, i, 0, 0, i, 15, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 7, i, 0, 7, i, 15, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, i, 0, 6, i, 0, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, i, 15, 6, i, 15, blockstate, blockstate, false);
         }
         ...
         for(int j = 1; j <= 7; ++j) {
            ...
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 3, j, 7, 4, j, 8, blockstate1, blockstate1, false);
         }
   ...
   public static class MonumentBuilding extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         int i = Math.max(p_225577_1_.getSeaLevel(), 64) - this.boundingBox.minY;
         this.makeOpening(p_225577_1_, p_225577_4_, 0, 0, 0, 58, i, 58);
            ...
            while(k < 7) {
               ...
               for(int j1 = 0; j1 < 4; ++j1) {
                  for(int k1 = 0; k1 < 4; ++k1) {
                     this.setBlockState(p_225577_1_, BRICKS_PRISMARINE, l + j1, 0, i1 + k1, p_225577_4_);
                     this.replaceAirAndLiquidDownwards(p_225577_1_, BRICKS_PRISMARINE, l + j1, -1, i1 + k1, p_225577_4_);
                  }
               }
         ...
         for(int l1 = 0; l1 < 5; ++l1) {
            this.makeOpening(p_225577_1_, p_225577_4_, -1 - l1, 0 + l1 * 2, -1 - l1, -1 - l1, 23, 58 + l1);
            this.makeOpening(p_225577_1_, p_225577_4_, 58 + l1, 0 + l1 * 2, -1 - l1, 58 + l1, 23, 58 + l1);
            this.makeOpening(p_225577_1_, p_225577_4_, 0 - l1, 0 + l1 * 2, -1 - l1, 57 + l1, 23, -1 - l1);
            this.makeOpening(p_225577_1_, p_225577_4_, 0 - l1, 0 + l1 * 2, 58 + l1, 57 + l1, 23, 58 + l1);
         }

         for(OceanMonumentPieces.Piece oceanmonumentpieces$piece : this.childPieces) {
            if (oceanmonumentpieces$piece.getBoundingBox().intersectsWith(p_225577_4_)) {
               oceanmonumentpieces$piece.func_225577_a_(p_225577_1_, p_225577_2_, p_225577_3_, p_225577_4_, p_225577_5_);
            }
         }
   ...
   public static class MonumentCoreRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         int i = 7;
         BlockState blockstate = BRICKS_PRISMARINE;
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 0, 7, 0, 0, 7, 15, blockstate, blockstate, false);
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 15, 7, 0, 15, 7, 15, blockstate, blockstate, false);
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, 7, 0, 15, 7, 0, blockstate, blockstate, false);
         this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, 7, 15, 14, 7, 15, blockstate, blockstate, false);
         ...
         for(int k = 1; k <= 6; ++k) {
            ...
            for(int j = 0; j <= 15; j += 15) {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, j, k, 0, j, k, 1, blockstate, blockstate, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, j, k, 6, j, k, 9, blockstate, blockstate, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, j, k, 14, j, k, 15, blockstate, blockstate, false);
            }

            this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, k, 0, 1, k, 0, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 6, k, 0, 9, k, 0, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 14, k, 0, 14, k, 0, blockstate, blockstate, false);
            this.fillWithBlocks(p_225577_1_, p_225577_4_, 1, k, 15, 14, k, 15, blockstate, blockstate, false);
         }
         ...
         for(int l = 3; l <= 6; l += 3) {
            for(int i1 = 6; i1 <= 9; i1 += 3) {
               this.setBlockState(p_225577_1_, SEA_LANTERN, i1, l, 6, p_225577_4_);
               this.setBlockState(p_225577_1_, SEA_LANTERN, i1, l, 9, p_225577_4_);
            }
         }
   ...
   public static class Penthouse extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         for(int i = 2; i <= 11; i += 3) {
            this.setBlockState(p_225577_1_, SEA_LANTERN, 0, 0, i, p_225577_4_);
            this.setBlockState(p_225577_1_, SEA_LANTERN, 13, 0, i, p_225577_4_);
            this.setBlockState(p_225577_1_, SEA_LANTERN, i, 0, 0, p_225577_4_);
         }
         ...
         for(int j = 0; j < 2; ++j) {
            for(int k = 2; k <= 8; k += 3) {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, l, 0, k, l, 2, k, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
            }
   ...
   public static class SimpleRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         ...
         boolean flag = this.mainDesign != 0 && p_225577_3_.nextBoolean() && !this.roomDefinition.hasOpening[Direction.DOWN.getIndex()] && !this.roomDefinition.hasOpening[Direction.UP.getIndex()] && this.roomDefinition.countOpenings() > 1;
         ...
         for(int i = 1; i <= 6; ++i) {
            for(int j = 1; j <= 6; ++j) {
               if (p_225577_3_.nextInt(3) != 0) {
                  int k = 2 + (p_225577_3_.nextInt(4) == 0 ? 0 : 1);
                  BlockState blockstate = Blocks.WET_SPONGE.getDefaultState();
                  this.fillWithBlocks(p_225577_1_, p_225577_4_, i, k, j, i, 3, j, blockstate, blockstate, false);
               }
            }
         }
   ...
   public static class WingRoom extends OceanMonumentPieces.Piece {
      ...
      public boolean func_225577_a_(IWorld p_225577_1_, ChunkGenerator<?> p_225577_2_, Random p_225577_3_, MutableBoundingBox p_225577_4_, ChunkPos p_225577_5_) {
         if (this.mainDesign == 0) {
            for(int i = 0; i < 4; ++i) {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, 10 - i, 3 - i, 20 - i, 12 + i, 3 - i, 20, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
            }
            ...
            for(int i1 = 18; i1 >= 7; i1 -= 3) {
               this.setBlockState(p_225577_1_, SEA_LANTERN, 6, 3, i1, p_225577_4_);
               this.setBlockState(p_225577_1_, SEA_LANTERN, 16, 3, i1, p_225577_4_);
            }
            ...
            for(int l = 0; l < 2; ++l) {
               this.setBlockState(p_225577_1_, BRICKS_PRISMARINE, j1, 6, 20, p_225577_4_);
               this.setBlockState(p_225577_1_, SEA_LANTERN, j1, 5, 20, p_225577_4_);
               this.setBlockState(p_225577_1_, BRICKS_PRISMARINE, j1, 4, 20, p_225577_4_);
               j1 = 13;
            }
            ...
            for(int k1 = 0; k1 < 2; ++k1) {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, j1, 0, 10, j1, 6, 10, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, j1, 0, 12, j1, 6, 12, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.setBlockState(p_225577_1_, SEA_LANTERN, j1, 0, 10, p_225577_4_);
               this.setBlockState(p_225577_1_, SEA_LANTERN, j1, 0, 12, p_225577_4_);
               this.setBlockState(p_225577_1_, SEA_LANTERN, j1, 4, 10, p_225577_4_);
               this.setBlockState(p_225577_1_, SEA_LANTERN, j1, 4, 12, p_225577_4_);
               j1 = 12;
            }
            ...
            for(int l1 = 0; l1 < 2; ++l1) {
               this.fillWithBlocks(p_225577_1_, p_225577_4_, j1, 0, 7, j1, 2, 7, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               this.fillWithBlocks(p_225577_1_, p_225577_4_, j1, 0, 14, j1, 2, 14, BRICKS_PRISMARINE, BRICKS_PRISMARINE, false);
               j1 = 14;
            }
