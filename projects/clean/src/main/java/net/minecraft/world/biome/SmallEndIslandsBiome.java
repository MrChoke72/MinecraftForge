...
public class SmallEndIslandsBiome extends Biome {
   public SmallEndIslandsBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.RAW_GENERATION, Feature.END_ISLAND.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).func_227228_a_(Placement.END_ISLAND.func_227446_a_(IPlacementConfig.NO_PLACEMENT_CONFIG)));
