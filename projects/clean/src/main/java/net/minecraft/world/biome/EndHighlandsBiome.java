...
public class EndHighlandsBiome extends Biome {
   public EndHighlandsBiome() {
      ...
      this.addFeature(GenerationStage.Decoration.SURFACE_STRUCTURES, Feature.END_GATEWAY.withConfiguration(EndGatewayConfig.func_214702_a(EndDimension.SPAWN, true)).func_227228_a_(Placement.END_GATEWAY.func_227446_a_(IPlacementConfig.NO_PLACEMENT_CONFIG)));
      DefaultBiomeFeatures.func_225489_aq(this);
      this.addFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.CHORUS_PLANT.withConfiguration(IFeatureConfig.NO_FEATURE_CONFIG).func_227228_a_(Placement.CHORUS_PLANT.func_227446_a_(IPlacementConfig.NO_PLACEMENT_CONFIG)));
