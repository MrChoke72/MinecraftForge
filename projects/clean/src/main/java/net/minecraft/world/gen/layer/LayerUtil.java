...
public class LayerUtil {
   ...
   public static <T extends IArea, C extends IExtendedNoiseRandom<T>> IAreaFactory<T> func_227475_a_(WorldType p_227475_0_, OverworldGenSettings p_227475_1_, LongFunction<C> p_227475_2_) {
      ...
      IAreaFactory<T> lvt_8_1_ = (new BiomeLayer(p_227475_0_, p_227475_1_.getBiomeId())).apply(p_227475_2_.apply(200L), iareafactory);
      lvt_8_1_ = AddBambooForestLayer.INSTANCE.apply((IExtendedNoiseRandom)p_227475_2_.apply(1001L), lvt_8_1_);
      lvt_8_1_ = repeat(1000L, ZoomLayer.NORMAL, lvt_8_1_, 2, p_227475_2_);
      lvt_8_1_ = EdgeBiomeLayer.INSTANCE.apply((IExtendedNoiseRandom)p_227475_2_.apply(1000L), lvt_8_1_);
