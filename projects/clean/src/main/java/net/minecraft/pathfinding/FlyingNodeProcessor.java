...
public class FlyingNodeProcessor extends WalkNodeProcessor {
   ...
   public int findPathOptions(PathPoint[] pathOptions, PathPoint targetPoint) {
      ...
      PathPoint pathpoint6 = this.openPoint(targetPoint.x, targetPoint.y + 1, targetPoint.z + 1);
      if (this.func_227477_b_(pathpoint6) && this.func_227476_a_(pathpoint) && this.func_227476_a_(pathpoint4)) {
         pathOptions[i++] = pathpoint6;
      }

      PathPoint pathpoint7 = this.openPoint(targetPoint.x - 1, targetPoint.y + 1, targetPoint.z);
      if (this.func_227477_b_(pathpoint7) && this.func_227476_a_(pathpoint1) && this.func_227476_a_(pathpoint4)) {
         pathOptions[i++] = pathpoint7;
      }

      PathPoint pathpoint8 = this.openPoint(targetPoint.x + 1, targetPoint.y + 1, targetPoint.z);
      if (this.func_227477_b_(pathpoint8) && this.func_227476_a_(pathpoint2) && this.func_227476_a_(pathpoint4)) {
         pathOptions[i++] = pathpoint8;
      }

      PathPoint pathpoint9 = this.openPoint(targetPoint.x, targetPoint.y + 1, targetPoint.z - 1);
      ...
      PathPoint pathpoint11 = this.openPoint(targetPoint.x - 1, targetPoint.y - 1, targetPoint.z);
      ...
      PathPoint pathpoint13 = this.openPoint(targetPoint.x, targetPoint.y - 1, targetPoint.z - 1);
      ...
      PathPoint pathpoint14 = this.openPoint(targetPoint.x + 1, targetPoint.y, targetPoint.z - 1);
      ...
      PathPoint pathpoint15 = this.openPoint(targetPoint.x + 1, targetPoint.y, targetPoint.z + 1);
      if (this.func_227477_b_(pathpoint15) && this.func_227476_a_(pathpoint) && this.func_227476_a_(pathpoint2)) {
         pathOptions[i++] = pathpoint15;
      }

      PathPoint pathpoint16 = this.openPoint(targetPoint.x - 1, targetPoint.y, targetPoint.z - 1);
      ...
      PathPoint pathpoint17 = this.openPoint(targetPoint.x - 1, targetPoint.y, targetPoint.z + 1);
      if (this.func_227477_b_(pathpoint17) && this.func_227476_a_(pathpoint) && this.func_227476_a_(pathpoint1)) {
         pathOptions[i++] = pathpoint17;
      }

      PathPoint pathpoint18 = this.openPoint(targetPoint.x + 1, targetPoint.y + 1, targetPoint.z - 1);
      ...
      PathPoint pathpoint19 = this.openPoint(targetPoint.x + 1, targetPoint.y + 1, targetPoint.z + 1);
      ...
      PathPoint pathpoint20 = this.openPoint(targetPoint.x - 1, targetPoint.y + 1, targetPoint.z - 1);
      ...
      PathPoint pathpoint21 = this.openPoint(targetPoint.x - 1, targetPoint.y + 1, targetPoint.z + 1);
      ...
      PathPoint pathpoint22 = this.openPoint(targetPoint.x + 1, targetPoint.y - 1, targetPoint.z - 1);
      ...
      PathPoint pathpoint23 = this.openPoint(targetPoint.x + 1, targetPoint.y - 1, targetPoint.z + 1);
      ...
      PathPoint pathpoint24 = this.openPoint(targetPoint.x - 1, targetPoint.y - 1, targetPoint.z - 1);
      ...
      PathPoint pathpoint25 = this.openPoint(targetPoint.x - 1, targetPoint.y - 1, targetPoint.z + 1);
      ...
      if (pathnodetype == PathNodeType.OPEN && y >= 1) {
         ...
         if (pathnodetype1 != PathNodeType.DAMAGE_FIRE && block != Blocks.MAGMA_BLOCK && pathnodetype1 != PathNodeType.LAVA && block != Blocks.CAMPFIRE) {
            if (pathnodetype1 == PathNodeType.DAMAGE_CACTUS) {
             ...
             //AH CHANGE ADD ******
            } else if (pathnodetype1 == PathNodeType.SCAFFOLDING) {
