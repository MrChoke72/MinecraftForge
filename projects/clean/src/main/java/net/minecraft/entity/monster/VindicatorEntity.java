...
public class VindicatorEntity extends AbstractIllagerEntity {
   ...
   //AH CHANGE REFACTOR
   private static final Predicate<Difficulty> checkDifficulty = (p_213678_0_) -> {
   ...
   protected void registerGoals() {
      ...
      //AH CHANGE ADD
      this.goalSelector.addGoal(2, new AbstractIllagerEntity.RaidOpenTrapDoorGoal(this));
   ...
   public ILivingEntityData onInitialSpawn(IWorld worldIn, DifficultyInstance difficultyIn, SpawnReason reason, @Nullable ILivingEntityData spawnDataIn, @Nullable CompoundNBT dataTag) {
      ...
      {
         //1% chance of spawned johnny cakes
         setCustomName(new StringTextComponent("Johnny"));
      }
      //AH CHANGE END ******
   ...
   static class BreakDoorGoal extends net.minecraft.entity.ai.goal.BreakDoorGoal {
      public BreakDoorGoal(MobEntity p_i50578_1_) {
         super(p_i50578_1_, 6, VindicatorEntity.checkDifficulty);
