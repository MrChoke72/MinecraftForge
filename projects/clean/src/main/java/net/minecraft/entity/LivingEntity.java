...
public abstract class LivingEntity extends Entity {
   ...
   //public void travel(Vec3d p_213352_1_) {
      if (this.isServerWorld() || this.canPassengerSteer()) {
         ...
         if (!this.isInWater() || this instanceof PlayerEntity && ((PlayerEntity)this).abilities.isFlying) {
            ...
            this.moveRelative(f1, moveVecIn);
            this.move(MoverType.SELF, this.getMotion());
   ...
   //private Vec3d func_213362_f(Vec3d p_213362_1_) {
      if (this.isOnLadder()) {
         this.fallDistance = 0.0F;
         double d0 = MathHelper.clamp(motionVec.x, (double)-0.15F, (double)0.15F);
   ...
   public void livingTick() {
      ...
      if (this.isJumping) {
         if (!(this.submergedHeight > 0.0D) || this.onGround && !(this.submergedHeight > 0.4D)) {
            ...
            //AH CHANGE
            } else if ((this.onGround || this.forceJump || this.submergedHeight > 0.0D && this.submergedHeight <= 0.4D) && this.jumpTicks == 0) {
