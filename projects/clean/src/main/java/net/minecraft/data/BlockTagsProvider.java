...
public class BlockTagsProvider extends TagsProvider<Block> {
   ...
   protected void registerTags() {
      ...
      this.getBuilder(BlockTags.WITHER_IMMUNE).add(Blocks.BARRIER, Blocks.BEDROCK, Blocks.END_PORTAL, Blocks.END_PORTAL_FRAME, Blocks.END_GATEWAY, Blocks.COMMAND_BLOCK, Blocks.REPEATING_COMMAND_BLOCK, Blocks.CHAIN_COMMAND_BLOCK, Blocks.STRUCTURE_BLOCK, Blocks.field_226904_lY_, Blocks.MOVING_PISTON);
      this.getBuilder(BlockTags.field_226148_H_).add(Blocks.SUNFLOWER, Blocks.LILAC, Blocks.PEONY, Blocks.ROSE_BUSH);
      this.getBuilder(BlockTags.field_226149_I_).add(BlockTags.SMALL_FLOWERS).add(BlockTags.field_226148_H_);
      this.getBuilder(BlockTags.field_226151_aa_).add(Blocks.field_226905_ma_, Blocks.field_226906_mb_);
      this.getBuilder(BlockTags.field_226152_ab_).add(Blocks.BEETROOTS, Blocks.CARROTS, Blocks.POTATOES, Blocks.WHEAT, Blocks.MELON_STEM, Blocks.PUMPKIN_STEM);
      this.getBuilder(BlockTags.field_226153_ac_).add(BlockTags.field_226152_ab_).add(Blocks.SWEET_BERRY_BUSH);
      this.getBuilder(BlockTags.field_226150_J_).add(Blocks.SHULKER_BOX, Blocks.BLACK_SHULKER_BOX, Blocks.BLUE_SHULKER_BOX, Blocks.BROWN_SHULKER_BOX, Blocks.CYAN_SHULKER_BOX, Blocks.GRAY_SHULKER_BOX, Blocks.GREEN_SHULKER_BOX, Blocks.LIGHT_BLUE_SHULKER_BOX, Blocks.LIGHT_GRAY_SHULKER_BOX, Blocks.LIME_SHULKER_BOX, Blocks.MAGENTA_SHULKER_BOX, Blocks.ORANGE_SHULKER_BOX, Blocks.PINK_SHULKER_BOX, Blocks.PURPLE_SHULKER_BOX, Blocks.RED_SHULKER_BOX, Blocks.WHITE_SHULKER_BOX, Blocks.YELLOW_SHULKER_BOX);
      this.getBuilder(BlockTags.field_226154_ad_).add(Blocks.NETHER_PORTAL, Blocks.END_PORTAL, Blocks.END_GATEWAY);
   }
