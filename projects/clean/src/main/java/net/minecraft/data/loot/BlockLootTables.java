...
public class BlockLootTables implements Consumer<BiConsumer<ResourceLocation, LootTable.Builder>> {
   ...
   protected static LootTable.Builder func_218463_a(IItemProvider p_218463_0_, IRandomRange p_218463_1_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(func_218552_a(p_218463_0_, ItemLootEntry.builder(p_218463_0_).acceptFunction(SetCount.createLootBuilder(p_218463_1_)))));
   }

   protected static LootTable.Builder func_218530_a(Block p_218530_0_, IItemProvider p_218530_1_, IRandomRange p_218530_2_) {
      return func_218519_a(p_218530_0_, func_218552_a(p_218530_0_, ItemLootEntry.builder(p_218530_1_).acceptFunction(SetCount.createLootBuilder(p_218530_2_))));
   }
   ...
   protected static LootTable.Builder func_218513_d(Block p_218513_0_) {
      return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(func_218552_a(p_218513_0_, ItemLootEntry.builder(p_218513_0_).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_218513_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227193_a_(SlabBlock.TYPE, SlabType.DOUBLE)))))));
   }
   ...
   protected static LootTable.Builder func_218491_c(Block p_218491_0_, IItemProvider p_218491_1_) {
      return func_218519_a(p_218491_0_, func_218552_a(p_218491_0_, ItemLootEntry.builder(p_218491_1_).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(-6.0F, 2.0F))).acceptFunction(LimitCount.func_215911_a(IntClamper.func_215848_a(0)))));
   }
   ...
   protected static LootTable.Builder func_218475_b(Block p_218475_0_, Item p_218475_1_) {
      return LootTable.builder().addLootPool(func_218552_a(p_218475_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_218475_1_).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.06666667F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 0)))).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.13333334F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 1)))).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.2F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 2)))).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.26666668F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 3)))).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.33333334F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 4)))).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.4F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 5)))).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.46666667F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 6)))).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.53333336F)).acceptCondition(BlockStateProperty.builder(p_218475_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(StemBlock.AGE, 7)))))));
   }

   private static LootTable.Builder func_229435_c_(Block p_229435_0_, Item p_229435_1_) {
      return LootTable.builder().addLootPool(func_218552_a(p_229435_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(p_229435_1_).acceptFunction(SetCount.createLootBuilder(BinomialRange.func_215838_a(3, 0.53333336F))))));
   }
   ...
   protected static LootTable.Builder func_218540_a(Block p_218540_0_, Block p_218540_1_, float... p_218540_2_) {
      return func_218535_c(p_218540_0_, func_218560_a(p_218540_0_, ItemLootEntry.builder(p_218540_1_)).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, p_218540_2_))).addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).acceptCondition(field_218577_e).addEntry(func_218552_a(p_218540_0_, ItemLootEntry.builder(Items.STICK).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(1.0F, 2.0F)))).acceptCondition(TableBonus.builder(Enchantments.FORTUNE, 0.02F, 0.022222223F, 0.025F, 0.033333335F, 0.1F))));
   }
   ...
   public void accept(BiConsumer<ResourceLocation, LootTable.Builder> p_accept_1_) {
      ...
      this.func_218492_c(Blocks.HONEY_BLOCK);
      this.func_218492_c(Blocks.HONEYCOMB_BLOCK);
      ...
      this.registerLootTable(Blocks.CHORUS_PLANT, func_218463_a(Items.CHORUS_FRUIT, RandomValueRange.createRandRange(0.0F, 1.0F)));
      ...
      this.registerLootTable(Blocks.COCOA, (p_218516_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(func_218552_a(p_218516_0_, ItemLootEntry.builder(Items.COCOA_BEANS).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(3)).acceptCondition(BlockStateProperty.builder(p_218516_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(CocoaBlock.AGE, 2)))))));
      });
      this.registerLootTable(Blocks.SEA_PICKLE, (p_218478_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().rolls(ConstantRange.of(1)).addEntry(func_218552_a(Blocks.SEA_PICKLE, ItemLootEntry.builder(p_218478_0_).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(2)).acceptCondition(BlockStateProperty.builder(p_218478_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 2)))).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(3)).acceptCondition(BlockStateProperty.builder(p_218478_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 3)))).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(4)).acceptCondition(BlockStateProperty.builder(p_218478_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SeaPickleBlock.PICKLES, 4)))))));
      });
      ...
      this.registerLootTable(Blocks.SWEET_BERRY_BUSH, (p_218538_0_) -> {
         return func_218552_a(p_218538_0_, LootTable.builder().addLootPool(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SweetBerryBushBlock.AGE, 3))).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(2.0F, 3.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))).addLootPool(LootPool.builder().acceptCondition(BlockStateProperty.builder(Blocks.SWEET_BERRY_BUSH).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SweetBerryBushBlock.AGE, 2))).addEntry(ItemLootEntry.builder(Items.SWEET_BERRIES)).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(1.0F, 2.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))));
      });
      ...
      this.registerLootTable(Blocks.LAPIS_ORE, (p_218548_0_) -> {
         return func_218519_a(p_218548_0_, func_218552_a(p_218548_0_, ItemLootEntry.builder(Items.LAPIS_LAZULI).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(4.0F, 9.0F))).acceptFunction(ApplyBonus.func_215869_a(Enchantments.FORTUNE))));
      });
      ...
      this.registerLootTable(Blocks.DEAD_BUSH, (p_218525_0_) -> {
         return func_218511_b(p_218525_0_, func_218552_a(p_218525_0_, ItemLootEntry.builder(Items.STICK).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(0.0F, 2.0F)))));
      });
      ...
      this.registerLootTable(Blocks.GLOWSTONE, (p_218496_0_) -> {
         return func_218519_a(p_218496_0_, func_218552_a(p_218496_0_, ItemLootEntry.builder(Items.GLOWSTONE_DUST).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(2.0F, 4.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE)).acceptFunction(LimitCount.func_215911_a(IntClamper.func_215843_a(1, 4)))));
      });
      this.registerLootTable(Blocks.MELON, (p_218532_0_) -> {
         return func_218519_a(p_218532_0_, func_218552_a(p_218532_0_, ItemLootEntry.builder(Items.MELON_SLICE).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(3.0F, 7.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE)).acceptFunction(LimitCount.func_215911_a(IntClamper.func_215851_b(9)))));
      });
      this.registerLootTable(Blocks.REDSTONE_ORE, (p_218464_0_) -> {
         return func_218519_a(p_218464_0_, func_218552_a(p_218464_0_, ItemLootEntry.builder(Items.REDSTONE).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(4.0F, 5.0F))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE))));
      });
      ...
      this.registerLootTable(Blocks.NETHER_WART, (p_218553_0_) -> {
         return LootTable.builder().addLootPool(func_218552_a(p_218553_0_, LootPool.builder().rolls(ConstantRange.of(1)).addEntry(ItemLootEntry.builder(Items.NETHER_WART).acceptFunction(SetCount.createLootBuilder(RandomValueRange.createRandRange(2.0F, 4.0F)).acceptCondition(BlockStateProperty.builder(p_218553_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(NetherWartBlock.AGE, 3)))).acceptFunction(ApplyBonus.func_215871_b(Enchantments.FORTUNE).acceptCondition(BlockStateProperty.builder(p_218553_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(NetherWartBlock.AGE, 3)))))));
      });
      this.registerLootTable(Blocks.SNOW, (p_218485_0_) -> {
         return LootTable.builder().addLootPool(LootPool.builder().acceptCondition(EntityHasProperty.func_215998_a(LootContext.EntityTarget.THIS)).addEntry(AlternativesLootEntry.func_216149_a(AlternativesLootEntry.func_216149_a(ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 1))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 2)))).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(2))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 3)))).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(3))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 4)))).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(4))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 5)))).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(5))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 6)))).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(6))), ((StandaloneLootEntry.Builder)ItemLootEntry.builder(Items.SNOWBALL).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 7)))).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(7))), ItemLootEntry.builder(Items.SNOWBALL).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(8)))).acceptCondition(field_218574_b), AlternativesLootEntry.func_216149_a(ItemLootEntry.builder(Blocks.SNOW).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 1))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(2))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 2))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(3))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 3))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(4))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 4))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(5))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 5))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(6))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 6))), ItemLootEntry.builder(Blocks.SNOW).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(7))).acceptCondition(BlockStateProperty.builder(p_218485_0_).func_227567_a_(StatePropertiesPredicate.Builder.func_227191_a_().func_227192_a_(SnowBlock.LAYERS, 7))), ItemLootEntry.builder(Blocks.SNOW_BLOCK)))));
      });
      ...
      this.registerLootTable(Blocks.CAMPFIRE, (p_218469_0_) -> {
         return func_218519_a(p_218469_0_, func_218560_a(p_218469_0_, ItemLootEntry.builder(Items.CHARCOAL).acceptFunction(SetCount.createLootBuilder(ConstantRange.of(2)))));
      });
