...
public class HusbandryAdvancements implements Consumer<Consumer<Advancement>> {
   ...
   public void accept(Consumer<Advancement> p_accept_1_) {
      ...
      Advancement advancement10 = Advancement.Builder.builder().withParent(advancement).withCriterion("safely_harvest_honey", RightClickBlockWithItemTrigger.Instance.func_226699_a_(BlockPredicate.Builder.func_226243_a_().func_226244_a_(BlockTags.field_226151_aa_), ItemPredicate.Builder.create().item(Items.GLASS_BOTTLE))).withDisplay(Items.field_226638_pX_, new TranslationTextComponent("advancements.husbandry.safely_harvest_honey.title"), new TranslationTextComponent("advancements.husbandry.safely_harvest_honey.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).register(p_accept_1_, "husbandry/safely_harvest_honey");
