...
public class ItemPickupParticle extends Particle {
   ...
   public void func_225606_a_(IVertexBuilder p_225606_1_, ActiveRenderInfo p_225606_2_, float p_225606_3_) {
      ...
      f = f * f;
      double d0 = MathHelper.lerp((double)p_225606_3_, this.target.lastTickPosX, this.target.getPosX());
      double d1 = MathHelper.lerp((double)p_225606_3_, this.target.lastTickPosY, this.target.getPosY()) + 0.5D;
      double d2 = MathHelper.lerp((double)p_225606_3_, this.target.lastTickPosZ, this.target.getPosZ());
