...
public class DefaultVertexFormats {
   ...
   public static final VertexFormat BLOCK = new VertexFormat(ImmutableList.<VertexFormatElement>builder().add(POSITION_3F).add(COLOR_4UB).add(TEX_2F).add(field_227848_e_).add(NORMAL_3B).add(PADDING_1B).build());
   public static final VertexFormat field_227849_i_ = new VertexFormat(ImmutableList.<VertexFormatElement>builder().add(POSITION_3F).add(COLOR_4UB).add(TEX_2F).add(TEX_2S).add(field_227848_e_).add(NORMAL_3B).add(PADDING_1B).build());
   @Deprecated
   public static final VertexFormat PARTICLE_POSITION_TEX_COLOR_LMAP = new VertexFormat(ImmutableList.<VertexFormatElement>builder().add(POSITION_3F).add(TEX_2F).add(COLOR_4UB).add(field_227848_e_).build());
   ...
   public static final VertexFormat field_227850_m_ = new VertexFormat(ImmutableList.<VertexFormatElement>builder().add(POSITION_3F).add(COLOR_4UB).add(field_227848_e_).build());
   ...
   public static final VertexFormat field_227851_o_ = new VertexFormat(ImmutableList.<VertexFormatElement>builder().add(POSITION_3F).add(COLOR_4UB).add(TEX_2F).build());
   @Deprecated
   ...
   public static final VertexFormat field_227852_q_ = new VertexFormat(ImmutableList.<VertexFormatElement>builder().add(POSITION_3F).add(COLOR_4UB).add(TEX_2F).add(field_227848_e_).build());
   @Deprecated
   public static final VertexFormat field_227853_r_ = new VertexFormat(ImmutableList.<VertexFormatElement>builder().add(POSITION_3F).add(TEX_2F).add(field_227848_e_).add(COLOR_4UB).build());
   @Deprecated
