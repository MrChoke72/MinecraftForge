...
public class EnderDragonRenderer extends EntityRenderer<EnderDragonEntity> {
   ...
   public void func_225623_a_(EnderDragonEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      if (p_225623_1_.field_70992_bH != null) {
         p_225623_4_.func_227860_a_();
         float f6 = (float)(p_225623_1_.field_70992_bH.getPosX() - MathHelper.lerp((double)p_225623_3_, p_225623_1_.prevPosX, p_225623_1_.getPosX()));
         float f8 = (float)(p_225623_1_.field_70992_bH.getPosY() - MathHelper.lerp((double)p_225623_3_, p_225623_1_.prevPosY, p_225623_1_.getPosY()));
         float f9 = (float)(p_225623_1_.field_70992_bH.getPosZ() - MathHelper.lerp((double)p_225623_3_, p_225623_1_.prevPosZ, p_225623_1_.getPosZ()));
