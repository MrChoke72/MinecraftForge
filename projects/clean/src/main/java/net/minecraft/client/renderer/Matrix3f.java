...
public final class Matrix3f {
   ...
   private static Quaternion stepJacobi(Matrix3f p_226120_0_) {
      ...
      if (p_226120_0_.m10 * p_226120_0_.m10 + p_226120_0_.m01 * p_226120_0_.m01 > 1.0E-6F) {
         Pair<Float, Float> pair = approxGivensQuat(p_226120_0_.m00, 0.5F * (p_226120_0_.m10 + p_226120_0_.m01), p_226120_0_.m11);
         ...
         p_226120_0_.setFrom(matrix3f);
      }

      if (p_226120_0_.m20 * p_226120_0_.m20 + p_226120_0_.m02 * p_226120_0_.m02 > 1.0E-6F) {
         Pair<Float, Float> pair1 = approxGivensQuat(p_226120_0_.m00, 0.5F * (p_226120_0_.m20 + p_226120_0_.m02), p_226120_0_.m22);
      ...
      if (p_226120_0_.m21 * p_226120_0_.m21 + p_226120_0_.m12 * p_226120_0_.m12 > 1.0E-6F) {
         Pair<Float, Float> pair2 = approxGivensQuat(p_226120_0_.m11, 0.5F * (p_226120_0_.m21 + p_226120_0_.m12), p_226120_0_.m22);
   ...
   public boolean equals(Object p_equals_1_) {
      if (this == p_equals_1_) {
         ...
         return Float.compare(matrix3f.m00, this.m00) == 0 && Float.compare(matrix3f.m10, this.m10) == 0 && Float.compare(matrix3f.m20, this.m20) == 0 && Float.compare(matrix3f.m01, this.m01) == 0 && Float.compare(matrix3f.m11, this.m11) == 0 && Float.compare(matrix3f.m21, this.m21) == 0 && Float.compare(matrix3f.m02, this.m02) == 0 && Float.compare(matrix3f.m12, this.m12) == 0 && Float.compare(matrix3f.m22, this.m22) == 0;
      } else {
         return false;
      }
   }
   ...
   public void setFrom(Matrix3f p_226114_1_) {
   ...
   public float adjugateAndDet() {
      ...
      float f1 = -(this.m01 * this.m22 - this.m21 * this.m02);
      float f2 = this.m01 * this.m12 - this.m11 * this.m02;
      float f3 = -(this.m10 * this.m22 - this.m20 * this.m12);
      float f4 = this.m00 * this.m22 - this.m20 * this.m02;
      float f5 = -(this.m00 * this.m12 - this.m10 * this.m02);
      float f6 = this.m10 * this.m21 - this.m20 * this.m11;
      float f7 = -(this.m00 * this.m21 - this.m20 * this.m01);
      float f8 = this.m00 * this.m11 - this.m10 * this.m01;
      float f9 = this.m00 * f + this.m10 * f1 + this.m20 * f2;
      this.m00 = f;
      this.m01 = f1;
      this.m02 = f2;
      this.m10 = f3;
   ...
   public void mul(Matrix3f p_226118_1_) {
      float f = this.m00 * p_226118_1_.m00 + this.m10 * p_226118_1_.m01 + this.m20 * p_226118_1_.m02;
      float f1 = this.m00 * p_226118_1_.m10 + this.m10 * p_226118_1_.m11 + this.m20 * p_226118_1_.m12;
      float f2 = this.m00 * p_226118_1_.m20 + this.m10 * p_226118_1_.m21 + this.m20 * p_226118_1_.m22;
      float f3 = this.m01 * p_226118_1_.m00 + this.m11 * p_226118_1_.m01 + this.m21 * p_226118_1_.m02;
      float f4 = this.m01 * p_226118_1_.m10 + this.m11 * p_226118_1_.m11 + this.m21 * p_226118_1_.m12;
      float f5 = this.m01 * p_226118_1_.m20 + this.m11 * p_226118_1_.m21 + this.m21 * p_226118_1_.m22;
      float f6 = this.m02 * p_226118_1_.m00 + this.m12 * p_226118_1_.m01 + this.m22 * p_226118_1_.m02;
      float f7 = this.m02 * p_226118_1_.m10 + this.m12 * p_226118_1_.m11 + this.m22 * p_226118_1_.m12;
      float f8 = this.m02 * p_226118_1_.m20 + this.m12 * p_226118_1_.m21 + this.m22 * p_226118_1_.m22;
      this.m00 = f;
      this.m10 = f1;
      this.m20 = f2;
      this.m01 = f3;
