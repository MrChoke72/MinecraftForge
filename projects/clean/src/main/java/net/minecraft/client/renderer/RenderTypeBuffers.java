...
public class RenderTypeBuffers {
   ...
   private final SortedMap<RenderType, BufferBuilder> fixedBuffers = Util.make(new Object2ObjectLinkedOpenHashMap<>(), (p_228485_1_) -> {
      p_228485_1_.put(Atlases.getSolidBlockType(), this.fixedBuilder.getBuilder(RenderType.solid()));
      p_228485_1_.put(Atlases.getCutoutBlockType(), this.fixedBuilder.getBuilder(RenderType.cutout()));
      p_228485_1_.put(Atlases.getBannerType(), this.fixedBuilder.getBuilder(RenderType.cutoutMipped()));
      p_228485_1_.put(Atlases.getTranslucentBlockType(), this.fixedBuilder.getBuilder(RenderType.translucent()));
   ...
   private static void put(Object2ObjectLinkedOpenHashMap<RenderType, BufferBuilder> mapBuildersIn, RenderType renderTypeIn) {
      mapBuildersIn.put(renderTypeIn, new BufferBuilder(renderTypeIn.defaultBufferSize()));
   }
