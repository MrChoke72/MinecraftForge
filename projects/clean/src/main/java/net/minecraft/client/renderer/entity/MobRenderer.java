...
public abstract class MobRenderer<T extends MobEntity, M extends EntityModel<T>> extends LivingRenderer<T, M> {
   ...
   private <E extends Entity> void func_229118_a_(T p_229118_1_, float p_229118_2_, MatrixStack p_229118_3_, IRenderTypeBuffer p_229118_4_, E p_229118_5_) {
      ...
      double d6 = MathHelper.lerp((double)p_229118_2_, p_229118_5_.prevPosX, p_229118_5_.getPosX()) - d2 * 0.7D - d3 * 0.5D * d5;
      double d7 = MathHelper.lerp((double)p_229118_2_, p_229118_5_.prevPosY + (double)p_229118_5_.getEyeHeight() * 0.7D, p_229118_5_.getPosY() + (double)p_229118_5_.getEyeHeight() * 0.7D) - d4 * 0.5D - 0.25D;
      double d8 = MathHelper.lerp((double)p_229118_2_, p_229118_5_.prevPosZ, p_229118_5_.getPosZ()) - d3 * 0.7D + d2 * 0.5D * d5;
      ...
      double d10 = MathHelper.lerp((double)p_229118_2_, p_229118_1_.prevPosX, p_229118_1_.getPosX()) + d2;
      double d11 = MathHelper.lerp((double)p_229118_2_, p_229118_1_.prevPosY, p_229118_1_.getPosY());
      double d12 = MathHelper.lerp((double)p_229118_2_, p_229118_1_.prevPosZ, p_229118_1_.getPosZ()) + d3;
