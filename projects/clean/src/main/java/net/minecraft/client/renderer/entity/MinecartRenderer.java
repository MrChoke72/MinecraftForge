...
public class MinecartRenderer<T extends AbstractMinecartEntity> extends EntityRenderer<T> {
   ...
   public void func_225623_a_(T p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_, IRenderTypeBuffer p_225623_5_, int p_225623_6_) {
      ...
      double d0 = MathHelper.lerp((double)p_225623_3_, p_225623_1_.lastTickPosX, p_225623_1_.getPosX());
      double d1 = MathHelper.lerp((double)p_225623_3_, p_225623_1_.lastTickPosY, p_225623_1_.getPosY());
      double d2 = MathHelper.lerp((double)p_225623_3_, p_225623_1_.lastTickPosZ, p_225623_1_.getPosZ());
