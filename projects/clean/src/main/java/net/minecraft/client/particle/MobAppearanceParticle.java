...
public class MobAppearanceParticle extends Particle {
   ...
   private final RenderType field_228341_A_ = RenderType.entityTranslucent(ElderGuardianRenderer.GUARDIAN_ELDER_TEXTURE);
   ...
   public void renderParticle(IVertexBuilder buffer, ActiveRenderInfo renderInfo, float partialTicks) {
      ...
      this.field_228342_a_.render(matrixstack, ivertexbuilder, 15728880, OverlayTexture.DEFAULT_LIGHT, 1.0F, 1.0F, 1.0F, f1);
