...
public class OverlayTexture implements AutoCloseable {
   public static final int DEFAULT_LIGHT = packLight(0, 10);
   ...
   public static int lightToInt(float uIn) {
   ...
   public static int packLight(int uIn, int vIn) {
      return uIn | vIn << 16;
   }

   public static int getPackedUV(float uIn, boolean hurtIn) {
      return packLight(lightToInt(uIn), getV(hurtIn));
   }
