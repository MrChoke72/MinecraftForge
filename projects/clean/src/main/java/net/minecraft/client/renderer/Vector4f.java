...
public class Vector4f {
   ...
   public void transform(Matrix4f matrixIn) {
      ...
      float f2 = this.z;
      float f3 = this.w;
      this.x = matrixIn.m00 * f + matrixIn.m10 * f1 + matrixIn.m20 * f2 + matrixIn.m30 * f3;
      this.y = matrixIn.m01 * f + matrixIn.m11 * f1 + matrixIn.m21 * f2 + matrixIn.m31 * f3;
      this.z = matrixIn.m02 * f + matrixIn.m12 * f1 + matrixIn.m22 * f2 + matrixIn.m32 * f3;
      this.w = matrixIn.m03 * f + matrixIn.m13 * f1 + matrixIn.m23 * f2 + matrixIn.m33 * f3;
   }
