...
public class SkullTileEntityRenderer extends TileEntityRenderer<SkullTileEntity> {
   ...
   public void render(SkullTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
      ...
      func_228879_a_(direction, f1, ((AbstractSkullBlock)blockstate.getBlock()).getSkullType(), tileEntityIn.getPlayerProfile(), f, matrixStackIn, bufferIn, combinedLightIn);
   }
   ...
   public static void func_228879_a_(@Nullable Direction p_228879_0_, float p_228879_1_, SkullBlock.ISkullType p_228879_2_, @Nullable GameProfile p_228879_3_, float p_228879_4_, MatrixStack p_228879_5_, IRenderTypeBuffer p_228879_6_, int p_228879_7_) {
      ...
      if (p_228879_0_ == null) {
         ...
         switch(p_228879_0_) {
         case NORTH:
            p_228879_5_.translate(0.5D, 0.25D, (double)0.74F);
            break;
         case SOUTH:
            p_228879_5_.translate(0.5D, 0.25D, (double)0.26F);
            break;
         case WEST:
            p_228879_5_.translate((double)0.74F, 0.25D, 0.5D);
            break;
         case EAST:
         default:
            p_228879_5_.translate((double)0.26F, 0.25D, 0.5D);
         }
      }
      ...
      genericheadmodel.render(p_228879_5_, ivertexbuilder, p_228879_7_, OverlayTexture.DEFAULT_LIGHT, 1.0F, 1.0F, 1.0F, 1.0F);
      p_228879_5_.pop();
   }
