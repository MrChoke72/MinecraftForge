...
public class GlStateManager {
   ...
   public static void blendFunc(int srcFactor, int dstFactor) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      if (srcFactor != BLEND.srcFactorRgb || dstFactor != BLEND.destFactorRgb) {
         BLEND.srcFactorRgb = srcFactor;
         BLEND.destFactorRgb = dstFactor;
   ...
   public static void blendFuncSeparate(int srcFactor, int dstFactor, int srcFactorAlpha, int dstFactorAlpha) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      if (srcFactor != BLEND.srcFactorRgb || dstFactor != BLEND.destFactorRgb || srcFactorAlpha != BLEND.srcFactorAlpha || dstFactorAlpha != BLEND.destFactorAlpha) {
         BLEND.srcFactorRgb = srcFactor;
         BLEND.destFactorRgb = dstFactor;
         BLEND.srcFactorAlpha = srcFactorAlpha;
         BLEND.destFactorAlpha = dstFactorAlpha;
   ...
   private static FloatBuffer getBuffer(float p_227710_0_, float p_227710_1_, float p_227710_2_, float p_227710_3_) {
      COLOR_BUFFER.clear();
      COLOR_BUFFER.put(p_227710_0_).put(p_227710_1_).put(p_227710_2_).put(p_227710_3_);
      COLOR_BUFFER.flip();
      return COLOR_BUFFER;
   }
   ...
   static class BlendState {
      ...
      public int destFactorRgb = 0;
      public int srcFactorAlpha = 1;
      public int destFactorAlpha = 0;
